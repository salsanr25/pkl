  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="{{('assets/frontend/hikers/images/img_1.jpg')}}" alt="Image" class="img-fluid">
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-5 text-center">
            <img src="{{('assets/frontend/hikers/images/person_1.jpg')}}" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-5 text-center">
            <img src="{{('assets/frontend/hikers/images/person_2.jpg')}}" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
            <h2 class="mb-3">Richard Cook</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum neque nobis eos quam necessitatibus rerum aliquid est tempore, cupiditate iure at voluptatum dolore, voluptates. Debitis accusamus, beatae ipsam excepturi mollitia.</p>
          </div>

          <div class="col-md-6 col-lg-4 mb-5 text-center">
            <img src="{{('assets/frontend/hikers/images/person_3.jpg')}}" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
