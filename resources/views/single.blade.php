...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{('assets/frontend/hikers/fonts/icomoon/style.css')}}">
    <link rel="stylesheet" href="{{('assets/frontend/hikers/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{('assets/frontend/hikers/css/magnific-popup.css')}}">
    <link rel="stylesheet" href="{{('assets/frontend/hikers/css/jquery-ui.css')}}">
    <link rel="stylesheet" href="{{('assets/frontend/hikers/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{('assets/frontend/hikers/css/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{('assets/frontend/hikers/css/bootstrap-datepicker.css')}}">
    <link rel="stylesheet" href="{{('assets/frontend/hikers/fonts/flaticon/font/flaticon.css')}}">
    <link rel="stylesheet" href="{{('assets/frontend/hikers/css/aos.css')}}">

    <link rel="stylesheet" href="{{('assets/frontend/hikers/css/style.css')}}">
  </head>
  <body>
        ...
        <div class="row same-height justify-content-center">
          <div class="col-md-12 col-lg-10">
            <div class="post-entry text-center">
              ...
              <h1 class="mb-4"><a href="#">The 20 Biggest Fintech Companies In America 2019</a></h1>
              <div class="post-meta align-items-center text-center">
                <figure class="author-figure mb-0 mr-3 d-inline-block"><img src="{{('assets/frontend/hikers/images/person_1.jpg')}}" alt="Image" class="img-fluid"></figure>
          ...
          <div class="col-md-12 col-lg-8 main-content">
            ...
            <div class="row mb-5 mt-5">
              <div class="col-md-12 mb-4">
                <img src="{{('assets/frontend/hikers/images/img_1.jpg')}}" alt="Image placeholder" class="img-fluid rounded">
              </div>
              <div class="col-md-6 mb-4">
                <img src="{{('assets/frontend/hikers/images/img_2.jpg')}}" alt="Image placeholder" class="img-fluid rounded">
              </div>
              <div class="col-md-6 mb-4">
                <img src="{{('assets/frontend/hikers/images/img_3.jpg')}}" alt="Image placeholder" class="img-fluid rounded">
              </div>
            </div>
            ...
            <div class="pt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard">
                    <img src="{{('assets/frontend/hikers/images/person_1.jpg')}}" alt="Image placeholder">
                  </div>
          ...
          <div class="col-md-12 col-lg-4 sidebar">
            ...
            <div class="sidebar-box">
              <div class="bio text-center">
                <img src="{{('assets/frontend/hikers/images/person_2.jpg')}}" alt="Image Placeholder" class="img-fluid mb-5">
                <div class="bio-body">
                  <h2>Craig David</h2>
            ...
            <div class="sidebar-box">
              ...
              <div class="post-entry-sidebar">
                <ul>
                  <li>
                    <a href="">
                      <img src="{{('assets/frontend/hikers/images/img_1.jpg')}}" alt="Image placeholder" class="mr-4">
                      <div class="text">
                  ...
                  <li>
                    <a href="">
                      <img src="{{('assets/frontend/hikers/images/img_2.jpg')}}" alt="Image placeholder" class="mr-4">
                      <div class="text">
                        <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                        <div class="post-meta">
                          <span class="mr-2">March 15, 2018 </span>
                  ...
                  <li>
                    <a href="">
                      <img src="{{('assets/frontend/hikers/images/img_3.jpg')}}" alt="Image placeholder" class="mr-4">
                      <div class="text">
                        <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                        <div class="post-meta">
                          <span class="mr-2">March 15, 2018 </span>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <div class="entry2 mb-5">
              <a href="#"><img src="{{('assets/frontend/hikers/images/img_1.jpg')}}" alt="Image" class="img-fluid rounded"></a>
              ...
              <div class="post-meta align-items-center text-left clearfix">
                <figure class="author-figure mb-0 mr-3 float-left"><img src="{{('assets/frontend/hikers/images/person_1.jpg')}}" alt="Image" class="img-fluid"></figure>
  ...
  <script src="{{('assets/frontend/hikers/js/jquery-3.3.1.min.js')}}"></script>
  <script src="{{('assets/frontend/hikers/js/jquery-migrate-3.0.1.min.js')}}"></script>
  <script src="{{('assets/frontend/hikers/js/jquery-ui.js')}}"></script>
  <script src="{{('assets/frontend/hikers/js/popper.min.js')}}"></script>
  <script src="{{('assets/frontend/hikers/js/bootstrap.min.js')}}"></script>
  <script src="{{('assets/frontend/hikers/js/owl.carousel.min.js')}}"></script>
  <script src="{{('assets/frontend/hikers/js/jquery.stellar.min.js')}}"></script>
  <script src="{{('assets/frontend/hikers/js/jquery.countdown.min.js')}}"></script>
  <script src="{{('assets/frontend/hikers/js/jquery.magnific-popup.min.js')}}"></script>
  <script src="{{('assets/frontend/hikers/js/bootstrap-datepicker.min.js')}}"></script>
  <script src="{{('assets/frontend/hikers/js/aos.js')}}"></script>

  <script src="{{('assets/frontend/hikers/js/main.js')}}"></script>
